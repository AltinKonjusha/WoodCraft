...
<head>
    ...
    <title><?= $id ? 'Edit Product' : 'Create Product' ?> — WoodCraft Admin</title>
...
<body>
    ...
    <div class="container" style="margin-top:120px; max-width: 720px;">
        ...
        <div class="admin-header mb-5">
            ...
            <p><?= $id ? 'Update product details' : 'Add a new product to the WoodCraft platform' ?></p>
        </div>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-save px-4">
                            <i class="fa fa-check me-1"></i> <?= $id ? 'Update Product' : 'Create Product' ?>
                        </button>
                    </div>
